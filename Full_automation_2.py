...
if st.session_state.inventory is None:
    ...
    if not os.path.exists(excel_file_path):
        ...
        st.warning("""
        **Setup Instructions:**
        1. Place your Excel file in the same folder as this Python script
        2. Update EXCEL_FILE_NAME at the top of the code
        3. Restart the app
        """)
        st.stop()
...
st.markdown(f"**Staff Kitchen Materials** • {len(inventory)} items available")
